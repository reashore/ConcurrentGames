...
namespace SportsIq.Distributor.Nfl
{
    public interface IDistributorNfl
    {
    ...
    public class DistributorNfl : IDistributorNfl
    {
        ...
        static DistributorNfl()
        {
            log4net.Config.XmlConfigurator.Configure();
            Logger = LogManager.GetLogger(typeof(DistributorNfl));
        }
        ...
        private void InitializeLists()
        {
            ...
            _altSpreadLines = new List<int> { 0, 125, 127, 256, 129, 131, 133, 135 };  //todo add 2nd half alt spread
            _totalLines = new List<int> { 0, 97, 102, 164, 107, 112, 117, 122 };

            _altTotalLines = new List<int> { 0, 126, 128, 257, 130, 132, 134, 136 };   //todo add 2nd half alt totals
            ...
            _spread3WLines = new List<int> { 0, 242, 243, 248, 244, 245, 246, 247 };
        ...
        public void SendMarkets(Dictionary<int, List<Market>> periodMarketsDictionary, Guid gameId, string match, Dictionary<string, double> gameState)
        {
            ...
            foreach (KeyValuePair<int, List<Market>> keyValuePair in periodMarketsDictionary)
            {
                ...
                {
                    Markets totallineAltSet = SetMarketActiveNew(totallineAlt, true, gameState);
                    SendOddsMessage(totallineAltSet, gameId, formattedMarketList);
                ...
                if (awayTotallineAlt.MarketList.Count > 0)
                {
                    ...
                    Markets totallineAltSet = SetMarketActiveNew(awayTotallineAlt, true, gameState);
                    SendOddsMessage(totallineAltSet, gameId, formattedMarketList);
                ...
                {
                    Markets totallineAltSet = SetMarketActiveNew(homeTotallineAlt, true, gameState);
                    SendOddsMessage(totallineAltSet, gameId, formattedMarketList);
                ...
                {
                    Markets totallineAltSet = SetMarketActiveNew(totalline3W, true, gameState);
                    SendOddsMessage(totallineAltSet, gameId, formattedMarketList);
                ...
                {
                    Markets handicap3WSet = SetMarketActiveNew(handicap3W, true, gameState);
                    SendOddsMessage(handicap3WSet, gameId, formattedMarketList);
