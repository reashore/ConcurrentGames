...
namespace SportsIq.Distributor.Nba
{
    public interface IDistributorNba
    {
   ...
   // Error CS1503  Argument 4: cannot convert from 'System.Collections.Generic.List<SportsIq.Games.Player>' to 'System.Collections.Generic.List<SportsIq.Distributor.Nba.Player>'	SportsIq.Games D:\workspace\SIQ\SportsIqNew\SportsIq.Games\Nba\NbaGame.cs	533	Active


    public class DistributorNba : DistributorBase, IDistributorNba
    {
        ...
        static DistributorNba()
        {
            log4net.Config.XmlConfigurator.Configure();
            Logger = LogManager.GetLogger(typeof(DistributorNba));
        }

        public DistributorNba(IDataAccessNba dataAccessNba, IDatastore datastore, IPusherUtil pusherUtil)
        {
            _datastore = datastore;
            PusherUtil = pusherUtil;
            _marketList = dataAccessNba.GetMarkets();
            InitializeLists();
            _gameSeconds = 2880;
        }
        ...
        public void SendMarkets(Dictionary<int, List<Market>> periodMarketsDictionary, Guid gameId, string match)
        {
            ...
            foreach (KeyValuePair<int, List<Market>> keyValuePair in periodMarketsDictionary)
            {
                try
                {
                    ...
                    {
                        Markets activeHandicapAlts = SetMarketActive(handicapAlts);
                    ...
                    {
                        Markets activeTotallineAlt = SetMarketActive(totallineAlt);
                    ...
                    {
                        Markets activeAwayTotallineAlt = SetMarketActive(awayTotallineAlt);
                    ...
                    {
                        Markets activeHomeTotallineAlt = SetMarketActive(homeTotallineAlt);
                    ...
                    Markets activeTotalline3W = SetMarketActive(totalline3W);
                    ...
                    Markets awayTotalline3W = new Markets
                    {
                        ...
                        //MarketList = marketList.FindAll(s =>
                        //    s.Tp == "ATTL3W" && !s.Target.IsEqualToZero() && s.MarketRunnerList[0].Probability > 0.035 &&
                        //    s.MarketRunnerList[0].Probability < 0.965)
                    };
                    ...
                    Markets homeTotalline3W = new Markets
                    {
                        ...
                        //MarketList = marketList.FindAll(s =>
                        //    s.Tp == "HTTL3W" && !s.Target.IsEqualToZero() && s.MarketRunnerList[0].Probability > 0.035 &&
                        //    s.MarketRunnerList[0].Probability < 0.965)
                    };

                    Markets activeHomeTotalline3W = SetMarketActive(homeTotalline3W);
                    ...
                    activeHomeTotalline3W = SetMarketActive(homeTotalline3WInactive);
                    ...
                    Markets activehandicap3W = SetMarketActive(handicap3W);
                    ...
                    Markets moneyLine3W = new Markets
                    {
                        ...
                        //MarketList = marketList.FindAll(s => s.Tp == "ML3" && s.MarketRunnerList[0].Probability > 0.035 &&
                        //                                     s.MarketRunnerList[0].Probability < 0.965)
                    };

                    Markets activeMoneyLine3W = SetMarketActive(moneyLine3W);
                    ...
                    activeMoneyLine3W = SetMarketActive(moneyLine3WInactive);
                    ...
                    Markets winningMargin = new Markets
                    {
                        ...
                        //MarketList = marketList.FindAll(s => s.Tp == "WMR" && s.MarketRunnerList[0].Probability > 0.035 &&
                        //                                     s.MarketRunnerList[0].Probability < 0.965)
                    };
                    Markets activeWinningMargin = SetMarketActive(winningMargin);
                    ...
                    Markets winningMarginCg = new Markets  // CG BECAUSE ITS C (complete) and G(game) 
                    {
                        ...
                        //MarketList = marketList.FindAll(s => s.Tp == "WMCG" && s.MarketRunnerList[0].Probability > 0.035 &&
                        //                                     s.MarketRunnerList[0].Probability < 0.965)
                    };
                    Markets activewinningMarginCg = SetMarketActive(winningMarginCg);
                    ...
                    Markets winnerTotal = new Markets
                    {
                        ...
                        //MarketList = marketList.FindAll(s => s.Tp == "C6W" && s.MarketRunnerList[0].Probability > 0.035 &&
                        //                                     s.MarketRunnerList[0].Probability < 0.965)
                    };
                    Markets activeWinnerTotal = SetMarketActive(winnerTotal);
                    ...
                    Markets spreadTotal = new Markets
                    {
                        ...
                        //MarketList = marketList.FindAll(s => s.Tp == "C4W" && s.MarketRunnerList[0].Probability > 0.035 &&
                        //                                     s.MarketRunnerList[0].Probability < 0.965)
                    };
                    Markets activeSpreadTotal = SetMarketActive(spreadTotal);
                    ...
                    activeSpreadTotal = SetMarketInactive(spreadTotal);
