...
namespace SportsIq.Distributor.Ncaabb
{
    public interface IDistributorNcaabb
    {
    ...
    public class DistributorNcaabb : DistributorBase, IDistributorNcaabb
    {
        ...
        static DistributorNcaabb()
        {
            log4net.Config.XmlConfigurator.Configure();
            Logger = LogManager.GetLogger(typeof(DistributorNcaabb));
        }

        public DistributorNcaabb(IDataAccessNcaabb dataAccessNcaabb, IDatastore datastore, IPusherUtil pusherUtil)
        {
            _datastore = datastore;
            PusherUtil = pusherUtil;
            _marketList = dataAccessNcaabb.GetMarkets();
            InitializeLists();
        }
