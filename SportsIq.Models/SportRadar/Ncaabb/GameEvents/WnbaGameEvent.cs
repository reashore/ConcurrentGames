...
namespace SportsIq.Models.SportRadar.Wnba.GameEvents
{
    // WnbaGameEvent wnbaGameEvent = WnbaGameEvent.FromJson(jsonString);

    public partial class WnbaGameEvent
    {
    ...
    public partial class WnbaGameEvent
    {
        public static WnbaGameEvent FromJson(string json) => JsonConvert.DeserializeObject<WnbaGameEvent>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WnbaGameEvent self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
