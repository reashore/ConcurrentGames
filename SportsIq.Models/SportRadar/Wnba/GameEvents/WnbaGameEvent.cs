...
// todo WARNING this file needs to be regenerated

namespace SportsIq.Models.SportRadar.Ncaabb.GameEvents
{
    // WnbaGameEvent wnbaGameEvent = WnbaGameEvent.FromJson(jsonString);

    public partial class NcaabbGameEvent
    {
    ...
    public partial class NcaabbGameEvent
    {
        public static NcaabbGameEvent FromJson(string json) => JsonConvert.DeserializeObject<NcaabbGameEvent>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this NcaabbGameEvent self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
