...
namespace SportsIq.Models.SportRadar.Ncaafb.GameEvents
{
    // NflGameEvent nflGameEvent = NflGameEvent.FromJson(jsonString);

    public partial class NcaafbGameEvent
    {
    ...
    public partial class NcaafbGameEvent
    {
        public static NcaafbGameEvent FromJson(string json) => JsonConvert.DeserializeObject<NcaafbGameEvent>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this NcaafbGameEvent self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
