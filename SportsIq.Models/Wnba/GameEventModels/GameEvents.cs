...
// var gameEvent = GameEvent.FromJson(jsonString);

namespace SportsIq.Models.Wnba.GameEventModels
{
    ...
    public partial class GameEvent
    {
        public static GameEvent FromJson(string json) => JsonConvert.DeserializeObject<GameEvent>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GameEvent self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
